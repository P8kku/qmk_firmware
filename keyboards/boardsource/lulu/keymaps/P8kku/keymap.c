 ...
 * |------+------+------+------+------+------|Mute   |   |Play    |------+------+------+------+------+------|
 * |LCTRL|   Z  |   X  |   C  |   V  |   B  |--------|   |--------|   N  |   M  |   ,  |   .  |   /  | HOME |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LAlt |LOWER | /Space  /       \Space \  |RAISE |      | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
//KC_RSFT "Right Shift"
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_AUDIO_MUTE,  KC_MEDIA_PLAY_PAUSE,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_HOME,
                           KC_LGUI, KC_LALT,    LOWER, KC_SPC, KC_SPC, RAISE, KC_BACKSLASH, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      | DEL  |
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_PIPE, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_END,
...
[_RAISE] = LAYOUT(
  ...
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                       XXXXXXX, KC_LBRC, KC_RBRC, KC_BSLS,   KC_UP, XXXXXXX,
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   RGB_TOG, _______,  KC_PLUS, KC_MINS, KC_EQL,  KC_LEFT, KC_DOWN, KC_RGHT,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
  [_QWERTY] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),  ENCODER_CCW_CW(LW_ZOOM_OUT, LW_ZOOM_IN) },
  ...
  [_ADJUST] = { ENCODER_CCW_CW(RGB_SAD, RGB_SAI),  ENCODER_CCW_CW(_______, _______) }
};
#endif
